...
| 模块 | TS文件数 | Go文件数 | 翻译进度 | 说明 |
|------|---------|---------|---------|------|
| **工具系统 (Tools)** | ~140 | 4 | 🔄 15% | 核心工具实现 |
| **命令系统 (Commands)** | ~101 | 2 | 🔄 5% | 斜杠命令实现 |
| **服务层 (Services)** | ~100 | 15 | 🔄 30% | API、MCP、LSP等 |
| **工具函数 (Utils)** | ~329 | 19 | 🔄 8% | 辅助工具函数 |

### 待翻译模块

| 模块 | 文件数 | 优先级 | 说明 |
|------|--------|-------|------|
| **UI 组件库** | ~144 | P0 | 需用 Bubble Tea 重构 |
| **Ink 终端框架** | ~60 | P0 | React CLI 框架 |
| **React Hooks** | ~85 | P1 | 需重新设计架构 |
| **桥接服务** | ~31 | P1 | 远程会话通信 |
| **工具子目录** | ~100 | P0 | 具体工具实现 |
| **命令子目录** | ~99 | P0 | 具体命令实现 |
